...
def launch_setup(context, *args, **kwargs):
    ...
    aruco_marker_publisher_params = {
        ...
        'reference_frame': f'{namespace}_color_frame',
        'camera_frame': f'{namespace}_color_frame',
    }
    ...
    aruco_marker_publisher = Node(
        ...
        namespace=namespace,
        remappings=[
            ('/camera_info', f'/camera/{namespace}/color/camera_info'),
            ('/image', f'/camera/{namespace}/color/image_raw'),
        ],
    )
